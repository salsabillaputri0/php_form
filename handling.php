									...
									<div id="profile-log-switch">
										<div class="card">
											<div class="card-body">
												<div class="card-header">
													<div class="media">
														<div class="media-user me-2">
															<div class="main-img-user avatar-md"><img alt="" class="rounded-circle" src="sacing.jpeg"></div>
														</div>
														<div class="media-body">
															<h6 class="mb-0 mg-t-9">Salsabilla Putri Ranesti</h6>
														</div>
														<div class="ms-auto">
												...
												<div><img alt="img" class="w-100" src="caca.jpeg"></div>
												<div class="media mg-t-15 profile-footer">
													<div class="media-user me-2">
														<div class="demo-avatar-group">
															<div class="demo-avatar-group main-avatar-list-stacked">
																<div class="main-img-user"><img alt="" class="rounded-circle" src="salsa1.jpeg"></div>
																<div class="main-img-user"><img alt="" class="rounded-circle" src="samiror.jpeg"></div>
																<div class="main-img-user"><img alt="" class="rounded-circle" src="salsabu.jpeg"></div>
																<div class="main-img-user online"><img alt="" class="rounded-circle" src="salsaor.jpeg"></div>
																<div class="main-img-user"><img alt="" class="rounded-circle" src="salsap.jpeg"></div>
										...
										<div class="card mg-b-20">
											<div class="card-body">
												<div class="card-header">
													<div class="media">
                                                    <div class="media-body">
															<h6 class="mb-0 mg-t-9">Hasil php_form_handling</h6>
														</div>
														<div class="ms-auto">
															<div class="dropdown show">
																<a class="new" data-bs-toggle="dropdown" href="JavaScript:void(0);"><i class="fas fa-ellipsis-v"></i></a>
												...
												<div class="media mg-t-15 profile-footer">
													<div class="media-user me-2">
														<div class="demo-avatar-group">
															<div class="demo-avatar-group main-avatar-list-stacked">
																<!-- Contoh di bawah ini menampilkan formulir HTML sederhana dengan dua kolom input dan tombol kirim: -->
